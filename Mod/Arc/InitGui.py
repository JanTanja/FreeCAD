...
__title__="FreeCAD ARC Workbench - Init File "
__author__ = "Jan Tanja <jtanja@ucmerced.edu>"
__url__ = ["arc-engines.com"]

class ArcWorkbench (Workbench):
    "the Arc Workbench"
    def __init__(self):
        self.__class__.Icon = FreeCAD.getResourceDir() + "Mod/Draft/Resources/icons/DraftWorkbench.svg"
        self.__class__.MenuText = "Arc"
        self.__class__.ToolTip = "Refer to the Google Sheet in ARC Documentation"
    ...
    def Initialize(self):
        ...
        try:
            import os,Draft_rc,DraftTools, DraftGui, Arc 
...
FreeCADGui.addWorkbench(ArcWorkbench)
